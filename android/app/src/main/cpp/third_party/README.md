...
`ggml-tiny-q5_1.bin` (quantize) **burada değil**; Flutter asset / `WhisperModelService` ile `assets/models/` ve uygulama dizinine kopyalanır. Ayrıca `assets/models/*.bin` genelde `.gitignore`’dadır.
